package com.arisen.order.service.impl;
...
import com.arisen.mapper.TbOrderItemMapper;
import com.arisen.mapper.TbOrderMapper;
import com.arisen.mapper.TbPayLogMapper;
import com.arisen.order.service.OrderService;
import com.arisen.pojo.TbOrder;
import com.arisen.pojo.TbOrderExample;
import com.arisen.pojo.TbOrderExample.Criteria;
import com.arisen.pojo.TbOrderItem;
import com.arisen.pojo.TbPayLog;
...
/////////////////////////////////////////////////////////////////////////////////////////////
	...
	@Override
	public void addOrder(TbOrder order,long orderId) {
		orderMapper.addOrder(order,orderId);
		
	}

	@Override
	public void addOrderItem(TbOrderItem orderItem) {
	...
	@Override
	public List<TbOrder> listOrder(Integer user_id) {
		return orderMapper.listOrder(user_id);
	}

	@Override
	public List<TbOrderItem> listOrderItem(long order_id) {
		return orderMapper.listOrderItem(order_id);
	}

	@Override
	public void updateOrderStatus(long order_id, String status) {
		Date date = new Date();
		orderMapper.updateOrderStatus(order_id,status,date);
	}
